...
<table width='100%' bgcolor='#e0e0e0' cellpadding='0' cellspacing='0' border='0'>
    ...
    <tr><td>
            ...
            <table align='center' width='100%' border='0' cellpadding='0' cellspacing='0' style='max-width:650px; background-color:#fff; font-family:Verdana, Geneva, sans-serif;'>
                ...
                <thead>
                <tr height='80'>
                    <th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;'>Commande N°${NCommande}</th>
                </tr>
                </thead>
                ...
                <tr>
                    <td colspan='4' style='padding:15px;'>
                        <p style='font-size:20px;'>Cher ${Name} ,</p>
                        <p style='font-size:13px; font-family:Verdana, Geneva, sans-serif; text-justify: auto'> Nous souhaitions vous remercier pour votre commande N°${NCommande} au sein de notre entreprise. <br>

                            Dans l'attente de la livraison de votre colis, nous vous invitons à découvrir d'autres  produits susceptibles de vous intéresser. </p>

                        <div style="text-align: center;
"><button center style="background-color: #008CBA; /* Green */
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  ...
  font-size: 16px;
">
                                <a href="http://localhost:8080/gestionDeStock/v1/api/commandeFournisseur/users/export/pdf" style="text-decoration : none;color: white;">Télécharger mon facture</a></button>
                        </div> </td>
                </tr>

                <tr height='80'>
                    <td colspan='4' align='center' style='background-color:#f5f5f5; border-top:dashed #00a2d1 2px; font-size:24px; '>
                        <p style='font-size:10px; font-family:Verdana, Geneva, sans-serif; text-align:center'>Merci de ne pas répondre à cet e-mail Ceci est un e-mail automatique. Si vous répondez, il ne peut pas être lu. Ce message a été envoyé à${Name}</p>
                        <label>
                            Trouver nous sur :
