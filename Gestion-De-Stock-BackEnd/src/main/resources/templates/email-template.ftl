...
"><button center style="background-color: #008CBA; /* Green */
  ...
  font-size: 16px;
">
                            <a href="http://localhost:8080/gestionDeStock/v1/api/commandeClient/users/export/pdf" style="text-decoration : none;color: white;">Télécharger mon facture</a></button>
                        </div> </td>
                </tr>
